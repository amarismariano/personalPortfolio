export const projects = [
  {
    title: "Vet app",
    description: "App that simulates appointment record requests for a veterinarian, such as adding new patients or deleting patients that have been discharged",
