export const projects = [
  ...
  },
  {
    title: "Vet app",
    description:
      "App that simulates appointment record requests for a veterinarian, such as adding new patients or deleting patients that have been discharged",
    image: "/images/vet2.gif",
  ...
  },
  {
    title: "Weather app",
    description:
      "Application that allows us to see the weather of different cities plus its forecast for the following days",
  ...
  },
  {
    title: "Loan App ",
    description:
      "A simple application that allows us to evaluate how much money we can borrow with a fixed term plus monthly payments",
  ...
  },
  {
    title: "Add Users ",
    description:
      "A simple app that I used as a way to learn React hooks that allow us to add and remove users to a list.",
  ...
  },
  {
    title: "Expenses ",
    description:
      "An application that helps us to have a history of our expenses throughout the month and tells us in which months we have spent the most",
...
export const TimeLineData = [
  ...
  {
    year: "",
    text: "Web Responsive Design Course and Several Courses at FreeCodeCamp",
  },
